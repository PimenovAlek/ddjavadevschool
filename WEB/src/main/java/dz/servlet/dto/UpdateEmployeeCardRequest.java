...
public class UpdateEmployeeCardRequest {
    ...
    public UpdateEmployeeCardRequest(Long id, String firstName, String lastName, String thirdName, String login, String password, CompanyUnit companyUnit, Roles roles, UserPosition userPosition) {
        this.id = id;
    ...
    public UpdateEmployeeCardRequest() {
    }
